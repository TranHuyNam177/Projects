...
class PATH:
    ...
    # path = r"C:\DataAnalytics\automation\risk_management\MonitorStockReport\path.json"  # server
    path = r"D:\DataAnalytics\automation\risk_management\MonitorStockReport\path.json"
